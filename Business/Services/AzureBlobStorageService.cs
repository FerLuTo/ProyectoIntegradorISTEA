...
namespace Business.Services
{
    public class AzureBlobStorageService : IAzureBlobStorageService
    {
        ...
        {
            azureStorageConnectionString = configuration.GetValue<string>("AzureStorageConnectionString");
        }
        ...
        public async Task<string> UploadAsync(IFormFile file, ContainerEnum container, string blobName = null)
        {
            ...
            var blobHttpHeader = new BlobHttpHeaders { ContentType = file.FileName };
